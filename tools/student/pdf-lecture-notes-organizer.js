...
export default function ToolPage() {
  return (
    <>
      <Head>
        <title>PDF Lecture Notes Organizer - Dicetools</title>
        <meta name="description" content="Placeholder for PDF Lecture Notes Organizer — Dicetools" />
      </Head>
      <section>
        <h1 className="text-2xl font-bold mb-4">PDF Lecture Notes Organizer</h1>
