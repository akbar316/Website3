...
export default function ToolPage() {
  return (
    <>
      <Head>
        <title>Formula Sheet Creator - Dicetools</title>
        <meta name="description" content="Placeholder for Formula Sheet Creator — Dicetools" />
      </Head>
      <section>
        <h1 className="text-2xl font-bold mb-4">Formula Sheet Creator</h1>
