...
export default function ToolPage() {
  return (
    <>
      <Head>
        <title>GPA Calculator - Dicetools</title>
        <meta name="description" content="Placeholder for GPA Calculator — Dicetools" />
      </Head>
      <section>
