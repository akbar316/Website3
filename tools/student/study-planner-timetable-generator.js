...
export default function ToolPage() {
  return (
    <>
      <Head>
        <title>Study Planner / Timetable Generator - Dicetools</title>
        <meta name="description" content="Placeholder for Study Planner / Timetable Generator — Dicetools" />
      </Head>
      <section>
        <h1 className="text-2xl font-bold mb-4">Study Planner / Timetable Generator</h1>
