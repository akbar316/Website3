...
export default function ToolPage() {
  return (
    <>
      <Head>
        <title>Flashcards Generator - Dicetools</title>
        <meta name="description" content="Placeholder for Flashcards Generator — Dicetools" />
      </Head>
      <section>
        <h1 className="text-2xl font-bold mb-4">Flashcards Generator</h1>
