...
export default function ToolPage() {
  return (
    <>
      <Head>
        <title>Periodic Table Explorer - Dicetools</title>
        <meta name="description" content="Placeholder for Periodic Table Explorer — Dicetools" />
      </Head>
      <section>
        <h1 className="text-2xl font-bold mb-4">Periodic Table Explorer</h1>
