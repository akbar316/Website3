...
export default function ToolPage() {
  return (
    <>
      <Head>
        <title>Unit Converter - Dicetools</title>
        <meta name="description" content="Placeholder for Unit Converter — Dicetools" />
      </Head>
      <section>
