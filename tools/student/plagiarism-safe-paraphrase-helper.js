...
export default function ToolPage() {
  return (
    <>
      <Head>
        <title>Plagiarism-safe paraphrase helper - Dicetools</title>
        <meta name="description" content="Placeholder for Plagiarism-safe paraphrase helper — Dicetools" />
      </Head>
      <section>
        <h1 className="text-2xl font-bold mb-4">Plagiarism-safe paraphrase helper</h1>
