...
export default function ToolPage() {
  return (
    <>
      <Head>
        <title>Math Solver - Dicetools</title>
        <meta name="description" content="Placeholder for Math Solver — Dicetools" />
      </Head>
      <section>
        <h1 className="text-2xl font-bold mb-4">Math Solver</h1>
