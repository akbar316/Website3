...
export default function ToolPage() {
  return (
    <>
      <Head>
        <title>Citation Generator - Dicetools</title>
        <meta name="description" content="Placeholder for Citation Generator — Dicetools" />
      </Head>
      <section>
        <h1 className="text-2xl font-bold mb-4">Citation Generator</h1>
