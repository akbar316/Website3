...
export default function ToolPage() {
  return (
    <>
      <Head>
        <title>PDF Rotate - Dicetools</title>
        <meta name="description" content="Placeholder for PDF Rotate — Dicetools" />
      </Head>
      <section>
        <h1 className="text-2xl font-bold mb-4">PDF Rotate</h1>
