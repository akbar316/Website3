...
export default function ToolPage() {
  return (
    <>
      <Head>
        <title>JPG to PDF - Dicetools</title>
        <meta name="description" content="Placeholder for JPG to PDF — Dicetools" />
      </Head>
      <section>
        <h1 className="text-2xl font-bold mb-4">JPG to PDF</h1>
