...
export default function ToolPage() {
  return (
    <>
      <Head>
        <title>PDF Metadata Editor - Dicetools</title>
        <meta name="description" content="Placeholder for PDF Metadata Editor — Dicetools" />
      </Head>
      <section>
        <h1 className="text-2xl font-bold mb-4">PDF Metadata Editor</h1>
