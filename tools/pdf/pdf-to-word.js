...
export default function ToolPage() {
  return (
    <>
      <Head>
        <title>PDF to Word - Dicetools</title>
        <meta name="description" content="Placeholder for PDF to Word — Dicetools" />
      </Head>
      <section>
