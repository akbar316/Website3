...
export default function ToolPage() {
  return (
    <>
      <Head>
        <title>PDF Stamping - Dicetools</title>
        <meta name="description" content="Placeholder for PDF Stamping — Dicetools" />
      </Head>
      <section>
        <h1 className="text-2xl font-bold mb-4">PDF Stamping</h1>
