...
export default function ToolPage() {
  return (
    <>
      <Head>
        <title>PDF Merge - Dicetools</title>
        <meta name="description" content="Placeholder for PDF Merge — Dicetools" />
      </Head>
      <section>
        <h1 className="text-2xl font-bold mb-4">PDF Merge</h1>
