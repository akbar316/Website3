...
export default function ToolPage() {
  return (
    <>
      <Head>
        <title>PDF Page Reorder - Dicetools</title>
        <meta name="description" content="Placeholder for PDF Page Reorder — Dicetools" />
      </Head>
      <section>
        <h1 className="text-2xl font-bold mb-4">PDF Page Reorder</h1>
