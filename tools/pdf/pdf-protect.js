...
export default function ToolPage() {
  return (
    <>
      <Head>
        <title>PDF Protect - Dicetools</title>
        <meta name="description" content="Placeholder for PDF Protect — Dicetools" />
      </Head>
      <section>
        <h1 className="text-2xl font-bold mb-4">PDF Protect</h1>
