...
export default function ToolPage() {
  return (
    <>
      <Head>
        <title>PDF Preview & Thumbnail Generator - Dicetools</title>
        <meta name="description" content="Placeholder for PDF Preview & Thumbnail Generator — Dicetools" />
      </Head>
      <section>
        <h1 className="text-2xl font-bold mb-4">PDF Preview & Thumbnail Generator</h1>
