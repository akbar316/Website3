...
export default function ToolPage() {
  return (
    <>
      <Head>
        <title>PDF Accessibility Checker - Dicetools</title>
        <meta name="description" content="Placeholder for PDF Accessibility Checker — Dicetools" />
      </Head>
      <section>
        <h1 className="text-2xl font-bold mb-4">PDF Accessibility Checker</h1>
