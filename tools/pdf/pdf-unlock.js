...
export default function ToolPage() {
  return (
    <>
      <Head>
        <title>PDF Unlock - Dicetools</title>
        <meta name="description" content="Placeholder for PDF Unlock — Dicetools" />
      </Head>
      <section>
        <h1 className="text-2xl font-bold mb-4">PDF Unlock</h1>
