...
export default function ToolPage() {
  return (
    <>
      <Head>
        <title>PDF Watermark - Dicetools</title>
        <meta name="description" content="Placeholder for PDF Watermark — Dicetools" />
      </Head>
      <section>
        <h1 className="text-2xl font-bold mb-4">PDF Watermark</h1>
