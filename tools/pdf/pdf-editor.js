...
export default function ToolPage() {
  return (
    <>
      <Head>
        <title>PDF Editor - Dicetools</title>
        <meta name="description" content="Placeholder for PDF Editor — Dicetools" />
      </Head>
      <section>
