...
export default function ToolPage() {
  return (
    <>
      <Head>
        <title>PDF to JPG - Dicetools</title>
        <meta name="description" content="Placeholder for PDF to JPG — Dicetools" />
      </Head>
      <section>
        <h1 className="text-2xl font-bold mb-4">PDF to JPG</h1>
