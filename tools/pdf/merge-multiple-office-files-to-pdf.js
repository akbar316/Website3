...
export default function ToolPage() {
  return (
    <>
      <Head>
        <title>Merge Multiple Office Files to PDF - Dicetools</title>
        <meta name="description" content="Placeholder for Merge Multiple Office Files to PDF — Dicetools" />
      </Head>
      <section>
        <h1 className="text-2xl font-bold mb-4">Merge Multiple Office Files to PDF</h1>
