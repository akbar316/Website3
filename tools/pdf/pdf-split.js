...
export default function ToolPage() {
  return (
    <>
      <Head>
        <title>PDF Split - Dicetools</title>
        <meta name="description" content="Placeholder for PDF Split — Dicetools" />
      </Head>
      <section>
        <h1 className="text-2xl font-bold mb-4">PDF Split</h1>
