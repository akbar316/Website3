...
export default function ToolPage() {
  return (
    <>
      <Head>
        <title>Word to PDF - Dicetools</title>
        <meta name="description" content="Placeholder for Word to PDF — Dicetools" />
      </Head>
      <section>
        <h1 className="text-2xl font-bold mb-4">Word to PDF</h1>
