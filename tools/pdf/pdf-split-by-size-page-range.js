...
export default function ToolPage() {
  return (
    <>
      <Head>
        <title>PDF Split by Size/Page Range - Dicetools</title>
        <meta name="description" content="Placeholder for PDF Split by Size/Page Range — Dicetools" />
      </Head>
      <section>
        <h1 className="text-2xl font-bold mb-4">PDF Split by Size/Page Range</h1>
