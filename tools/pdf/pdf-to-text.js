...
export default function ToolPage() {
  return (
    <>
      <Head>
        <title>PDF to Text - Dicetools</title>
        <meta name="description" content="Placeholder for PDF to Text — Dicetools" />
      </Head>
      <section>
        <h1 className="text-2xl font-bold mb-4">PDF to Text</h1>
