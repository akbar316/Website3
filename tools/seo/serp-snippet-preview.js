...
export default function ToolPage() {
  return (
    <>
      <Head>
        <title>SERP Snippet Preview - Dicetools</title>
        <meta name="description" content="Placeholder for SERP Snippet Preview — Dicetools" />
      </Head>
      <section>
        <h1 className="text-2xl font-bold mb-4">SERP Snippet Preview</h1>
