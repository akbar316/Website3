...
export default function ToolPage() {
  return (
    <>
      <Head>
        <title>Local SEO NAP Formatter - Dicetools</title>
        <meta name="description" content="Placeholder for Local SEO NAP Formatter — Dicetools" />
      </Head>
      <section>
        <h1 className="text-2xl font-bold mb-4">Local SEO NAP Formatter</h1>
