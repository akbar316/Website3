...
export default function ToolPage() {
  return (
    <>
      <Head>
        <title>Canonical URL Checker - Dicetools</title>
        <meta name="description" content="Placeholder for Canonical URL Checker — Dicetools" />
      </Head>
      <section>
        <h1 className="text-2xl font-bold mb-4">Canonical URL Checker</h1>
