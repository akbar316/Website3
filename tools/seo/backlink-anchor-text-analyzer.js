...
export default function ToolPage() {
  return (
    <>
      <Head>
        <title>Backlink Anchor Text Analyzer - Dicetools</title>
        <meta name="description" content="Placeholder for Backlink Anchor Text Analyzer — Dicetools" />
      </Head>
      <section>
        <h1 className="text-2xl font-bold mb-4">Backlink Anchor Text Analyzer</h1>
