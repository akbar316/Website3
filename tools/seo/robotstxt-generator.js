...
export default function ToolPage() {
  return (
    <>
      <Head>
        <title>Robots.txt Generator - Dicetools</title>
        <meta name="description" content="Placeholder for Robots.txt Generator — Dicetools" />
      </Head>
      <section>
        <h1 className="text-2xl font-bold mb-4">Robots.txt Generator</h1>
