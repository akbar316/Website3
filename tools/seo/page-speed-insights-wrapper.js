...
export default function ToolPage() {
  return (
    <>
      <Head>
        <title>Page Speed Insights Wrapper - Dicetools</title>
        <meta name="description" content="Placeholder for Page Speed Insights Wrapper — Dicetools" />
      </Head>
      <section>
        <h1 className="text-2xl font-bold mb-4">Page Speed Insights Wrapper</h1>
