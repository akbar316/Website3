...
export default function ToolPage() {
  return (
    <>
      <Head>
        <title>Meta Tag Generator - Dicetools</title>
        <meta name="description" content="Placeholder for Meta Tag Generator — Dicetools" />
      </Head>
      <section>
