...
export default function ToolPage() {
  return (
    <>
      <Head>
        <title>Sitemap Generator - Dicetools</title>
        <meta name="description" content="Placeholder for Sitemap Generator — Dicetools" />
      </Head>
      <section>
