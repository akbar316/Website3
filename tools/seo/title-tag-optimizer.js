...
export default function ToolPage() {
  return (
    <>
      <Head>
        <title>Title Tag Optimizer - Dicetools</title>
        <meta name="description" content="Placeholder for Title Tag Optimizer — Dicetools" />
      </Head>
      <section>
        <h1 className="text-2xl font-bold mb-4">Title Tag Optimizer</h1>
