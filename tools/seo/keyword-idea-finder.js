...
export default function ToolPage() {
  return (
    <>
      <Head>
        <title>Keyword Idea Finder - Dicetools</title>
        <meta name="description" content="Placeholder for Keyword Idea Finder — Dicetools" />
      </Head>
      <section>
        <h1 className="text-2xl font-bold mb-4">Keyword Idea Finder</h1>
