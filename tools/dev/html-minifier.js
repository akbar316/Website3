...
export default function ToolPage() {
  return (
    <>
      <Head>
        <title>HTML Minifier - Dicetools</title>
        <meta name="description" content="Placeholder for HTML Minifier — Dicetools" />
      </Head>
      <section>
