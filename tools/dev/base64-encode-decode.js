...
export default function ToolPage() {
  return (
    <>
      <Head>
        <title>Base64 Encode/Decode - Dicetools</title>
        <meta name="description" content="Placeholder for Base64 Encode/Decode — Dicetools" />
      </Head>
      <section>
        <h1 className="text-2xl font-bold mb-4">Base64 Encode/Decode</h1>
