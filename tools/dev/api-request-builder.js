...
export default function ToolPage() {
  return (
    <>
      <Head>
        <title>API Request Builder - Dicetools</title>
        <meta name="description" content="Placeholder for API Request Builder — Dicetools" />
      </Head>
      <section>
        <h1 className="text-2xl font-bold mb-4">API Request Builder</h1>
