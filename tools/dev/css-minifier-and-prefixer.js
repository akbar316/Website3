...
export default function ToolPage() {
  return (
    <>
      <Head>
        <title>CSS Minifier & Prefixer - Dicetools</title>
        <meta name="description" content="Placeholder for CSS Minifier & Prefixer — Dicetools" />
      </Head>
      <section>
        <h1 className="text-2xl font-bold mb-4">CSS Minifier & Prefixer</h1>
