...
export default function ToolPage() {
  return (
    <>
      <Head>
        <title>UUID Generator - Dicetools</title>
        <meta name="description" content="Placeholder for UUID Generator — Dicetools" />
      </Head>
      <section>
