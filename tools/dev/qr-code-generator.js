...
export default function ToolPage() {
  return (
    <>
      <Head>
        <title>QR Code Generator - Dicetools</title>
        <meta name="description" content="Placeholder for QR Code Generator — Dicetools" />
      </Head>
      <section>
