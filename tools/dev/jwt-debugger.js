...
export default function ToolPage() {
  return (
    <>
      <Head>
        <title>JWT Debugger - Dicetools</title>
        <meta name="description" content="Placeholder for JWT Debugger — Dicetools" />
      </Head>
      <section>
        <h1 className="text-2xl font-bold mb-4">JWT Debugger</h1>
