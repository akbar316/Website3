...
export default function ToolPage() {
  return (
    <>
      <Head>
        <title>Responsive Tester - Dicetools</title>
        <meta name="description" content="Placeholder for Responsive Tester — Dicetools" />
      </Head>
      <section>
        <h1 className="text-2xl font-bold mb-4">Responsive Tester</h1>
