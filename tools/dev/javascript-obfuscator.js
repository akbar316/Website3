...
export default function ToolPage() {
  return (
    <>
      <Head>
        <title>JavaScript Obfuscator - Dicetools</title>
        <meta name="description" content="Placeholder for JavaScript Obfuscator — Dicetools" />
      </Head>
      <section>
        <h1 className="text-2xl font-bold mb-4">JavaScript Obfuscator</h1>
