...
export default function ToolPage() {
  return (
    <>
      <Head>
        <title>Image Filter Playground - Dicetools</title>
        <meta name="description" content="Placeholder for Image Filter Playground — Dicetools" />
      </Head>
      <section>
        <h1 className="text-2xl font-bold mb-4">Image Filter Playground</h1>
