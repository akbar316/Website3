...
export default function ToolPage() {
  return (
    <>
      <Head>
        <title>Image Colorizer - Dicetools</title>
        <meta name="description" content="Placeholder for Image Colorizer — Dicetools" />
      </Head>
      <section>
        <h1 className="text-2xl font-bold mb-4">Image Colorizer</h1>
