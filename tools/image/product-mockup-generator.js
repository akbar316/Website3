...
export default function ToolPage() {
  return (
    <>
      <Head>
        <title>Product Mockup Generator - Dicetools</title>
        <meta name="description" content="Placeholder for Product Mockup Generator — Dicetools" />
      </Head>
      <section>
        <h1 className="text-2xl font-bold mb-4">Product Mockup Generator</h1>
