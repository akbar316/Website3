...
export default function ToolPage() {
  return (
    <>
      <Head>
        <title>Image Resizer - Dicetools</title>
        <meta name="description" content="Placeholder for Image Resizer — Dicetools" />
      </Head>
      <section>
