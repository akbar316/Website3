...
export default function ToolPage() {
  return (
    <>
      <Head>
        <title>Convert Image to Vector - Dicetools</title>
        <meta name="description" content="Placeholder for Convert Image to Vector — Dicetools" />
      </Head>
      <section>
        <h1 className="text-2xl font-bold mb-4">Convert Image to Vector</h1>
