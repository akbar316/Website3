...
export default function ToolPage() {
  return (
    <>
      <Head>
        <title>GIF to MP4 & MP4 to GIF - Dicetools</title>
        <meta name="description" content="Placeholder for GIF to MP4 & MP4 to GIF — Dicetools" />
      </Head>
      <section>
        <h1 className="text-2xl font-bold mb-4">GIF to MP4 & MP4 to GIF</h1>
