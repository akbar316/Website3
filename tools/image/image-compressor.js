...
export default function ToolPage() {
  return (
    <>
      <Head>
        <title>Image Compressor - Dicetools</title>
        <meta name="description" content="Placeholder for Image Compressor — Dicetools" />
      </Head>
      <section>
