...
export default function ToolPage() {
  return (
    <>
      <Head>
        <title>Screenshot to Image Editor - Dicetools</title>
        <meta name="description" content="Placeholder for Screenshot to Image Editor — Dicetools" />
      </Head>
      <section>
        <h1 className="text-2xl font-bold mb-4">Screenshot to Image Editor</h1>
