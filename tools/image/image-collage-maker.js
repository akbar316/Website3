...
export default function ToolPage() {
  return (
    <>
      <Head>
        <title>Image Collage Maker - Dicetools</title>
        <meta name="description" content="Placeholder for Image Collage Maker — Dicetools" />
      </Head>
      <section>
        <h1 className="text-2xl font-bold mb-4">Image Collage Maker</h1>
