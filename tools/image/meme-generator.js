...
export default function ToolPage() {
  return (
    <>
      <Head>
        <title>Meme Generator - Dicetools</title>
        <meta name="description" content="Placeholder for Meme Generator — Dicetools" />
      </Head>
      <section>
