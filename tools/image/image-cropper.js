...
export default function ToolPage() {
  return (
    <>
      <Head>
        <title>Image Cropper - Dicetools</title>
        <meta name="description" content="Placeholder for Image Cropper — Dicetools" />
      </Head>
      <section>
