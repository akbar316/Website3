...
export default function ToolPage() {
  return (
    <>
      <Head>
        <title>Image Metadata Editor - Dicetools</title>
        <meta name="description" content="Placeholder for Image Metadata Editor — Dicetools" />
      </Head>
      <section>
        <h1 className="text-2xl font-bold mb-4">Image Metadata Editor</h1>
