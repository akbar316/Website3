...
export default function ToolPage() {
  return (
    <>
      <Head>
        <title>Image to Cartoon / Stylize - Dicetools</title>
        <meta name="description" content="Placeholder for Image to Cartoon / Stylize — Dicetools" />
      </Head>
      <section>
        <h1 className="text-2xl font-bold mb-4">Image to Cartoon / Stylize</h1>
