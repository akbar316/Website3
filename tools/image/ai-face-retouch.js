...
export default function ToolPage() {
  return (
    <>
      <Head>
        <title>AI Face Retouch - Dicetools</title>
        <meta name="description" content="Placeholder for AI Face Retouch — Dicetools" />
      </Head>
      <section>
        <h1 className="text-2xl font-bold mb-4">AI Face Retouch</h1>
