...
export default function ToolPage() {
  return (
    <>
      <Head>
        <title>Image Watermarker - Dicetools</title>
        <meta name="description" content="Placeholder for Image Watermarker — Dicetools" />
      </Head>
      <section>
        <h1 className="text-2xl font-bold mb-4">Image Watermarker</h1>
