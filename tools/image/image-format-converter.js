...
export default function ToolPage() {
  return (
    <>
      <Head>
        <title>Image Format Converter - Dicetools</title>
        <meta name="description" content="Placeholder for Image Format Converter — Dicetools" />
      </Head>
      <section>
