...
export default function ToolPage() {
  return (
    <>
      <Head>
        <title>AI Image Generator - Dicetools</title>
        <meta name="description" content="Placeholder for AI Image Generator — Dicetools" />
      </Head>
      <section>
