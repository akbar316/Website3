...
export default function ToolPage() {
  return (
    <>
      <Head>
        <title>Batch Image Processor - Dicetools</title>
        <meta name="description" content="Placeholder for Batch Image Processor — Dicetools" />
      </Head>
      <section>
