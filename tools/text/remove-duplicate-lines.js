...
export default function ToolPage() {
  return (
    <>
      <Head>
        <title>Remove Duplicate Lines - Dicetools</title>
        <meta name="description" content="Placeholder for Remove Duplicate Lines — Dicetools" />
      </Head>
      <section>
        <h1 className="text-2xl font-bold mb-4">Remove Duplicate Lines</h1>
