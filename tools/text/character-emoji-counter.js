...
export default function ToolPage() {
  return (
    <>
      <Head>
        <title>Character / Emoji Counter - Dicetools</title>
        <meta name="description" content="Placeholder for Character / Emoji Counter — Dicetools" />
      </Head>
      <section>
        <h1 className="text-2xl font-bold mb-4">Character / Emoji Counter</h1>
