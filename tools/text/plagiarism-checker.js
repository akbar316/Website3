...
export default function ToolPage() {
  return (
    <>
      <Head>
        <title>Plagiarism Checker - Dicetools</title>
        <meta name="description" content="Placeholder for Plagiarism Checker — Dicetools" />
      </Head>
      <section>
