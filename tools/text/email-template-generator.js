...
export default function ToolPage() {
  return (
    <>
      <Head>
        <title>Email Template Generator - Dicetools</title>
        <meta name="description" content="Placeholder for Email Template Generator — Dicetools" />
      </Head>
      <section>
