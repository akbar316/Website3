...
export default function ToolPage() {
  return (
    <>
      <Head>
        <title>Lorem Ipsum Generator - Dicetools</title>
        <meta name="description" content="Placeholder for Lorem Ipsum Generator — Dicetools" />
      </Head>
      <section>
