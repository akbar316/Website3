...
export default function ToolPage() {
  return (
    <>
      <Head>
        <title>CSV to JSON and JSON to CSV - Dicetools</title>
        <meta name="description" content="Placeholder for CSV to JSON and JSON to CSV — Dicetools" />
      </Head>
      <section>
        <h1 className="text-2xl font-bold mb-4">CSV to JSON and JSON to CSV</h1>
