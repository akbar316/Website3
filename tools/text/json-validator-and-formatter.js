...
export default function ToolPage() {
  return (
    <>
      <Head>
        <title>JSON Validator & Formatter - Dicetools</title>
        <meta name="description" content="Placeholder for JSON Validator & Formatter — Dicetools" />
      </Head>
      <section>
        <h1 className="text-2xl font-bold mb-4">JSON Validator & Formatter</h1>
