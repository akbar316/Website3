...
export default function ToolPage() {
  return (
    <>
      <Head>
        <title>Text to Markdown Converter - Dicetools</title>
        <meta name="description" content="Placeholder for Text to Markdown Converter — Dicetools" />
      </Head>
      <section>
        <h1 className="text-2xl font-bold mb-4">Text to Markdown Converter</h1>
