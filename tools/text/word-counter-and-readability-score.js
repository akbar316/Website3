...
export default function ToolPage() {
  return (
    <>
      <Head>
        <title>Word Counter & Readability Score - Dicetools</title>
        <meta name="description" content="Placeholder for Word Counter & Readability Score — Dicetools" />
      </Head>
      <section>
        <h1 className="text-2xl font-bold mb-4">Word Counter & Readability Score</h1>
