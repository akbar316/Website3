...
export default function ToolPage() {
  return (
    <>
      <Head>
        <title>Grammar & Spell Checker - Dicetools</title>
        <meta name="description" content="Placeholder for Grammar & Spell Checker — Dicetools" />
      </Head>
      <section>
        <h1 className="text-2xl font-bold mb-4">Grammar & Spell Checker</h1>
