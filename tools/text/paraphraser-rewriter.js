...
export default function ToolPage() {
  return (
    <>
      <Head>
        <title>Paraphraser / Rewriter - Dicetools</title>
        <meta name="description" content="Placeholder for Paraphraser / Rewriter — Dicetools" />
      </Head>
      <section>
        <h1 className="text-2xl font-bold mb-4">Paraphraser / Rewriter</h1>
