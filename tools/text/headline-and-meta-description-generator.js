...
export default function ToolPage() {
  return (
    <>
      <Head>
        <title>Headline & Meta Description Generator - Dicetools</title>
        <meta name="description" content="Placeholder for Headline & Meta Description Generator — Dicetools" />
      </Head>
      <section>
        <h1 className="text-2xl font-bold mb-4">Headline & Meta Description Generator</h1>
