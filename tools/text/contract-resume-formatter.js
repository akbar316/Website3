...
export default function ToolPage() {
  return (
    <>
      <Head>
        <title>Contract / Resume Formatter - Dicetools</title>
        <meta name="description" content="Placeholder for Contract / Resume Formatter — Dicetools" />
      </Head>
      <section>
        <h1 className="text-2xl font-bold mb-4">Contract / Resume Formatter</h1>
