...
export default function ToolPage() {
  return (
    <>
      <Head>
        <title>Unit Price Calculator - Dicetools</title>
        <meta name="description" content="Placeholder for Unit Price Calculator — Dicetools" />
      </Head>
      <section>
        <h1 className="text-2xl font-bold mb-4">Unit Price Calculator</h1>
