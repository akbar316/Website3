...
export default function ToolPage() {
  return (
    <>
      <Head>
        <title>Two-factor Authenticator (TOTP generator) - Dicetools</title>
        <meta name="description" content="Placeholder for Two-factor Authenticator (TOTP generator) — Dicetools" />
      </Head>
      <section>
        <h1 className="text-2xl font-bold mb-4">Two-factor Authenticator (TOTP generator)</h1>
