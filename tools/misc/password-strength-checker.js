...
export default function ToolPage() {
  return (
    <>
      <Head>
        <title>Password Strength Checker - Dicetools</title>
        <meta name="description" content="Placeholder for Password Strength Checker — Dicetools" />
      </Head>
      <section>
