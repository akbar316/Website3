...
export default function ToolPage() {
  return (
    <>
      <Head>
        <title>File Hash Checker - Dicetools</title>
        <meta name="description" content="Placeholder for File Hash Checker — Dicetools" />
      </Head>
      <section>
        <h1 className="text-2xl font-bold mb-4">File Hash Checker</h1>
