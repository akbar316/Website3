...
export default function ToolPage() {
  return (
    <>
      <Head>
        <title>IP Geolocation Lookup - Dicetools</title>
        <meta name="description" content="Placeholder for IP Geolocation Lookup — Dicetools" />
      </Head>
      <section>
        <h1 className="text-2xl font-bold mb-4">IP Geolocation Lookup</h1>
