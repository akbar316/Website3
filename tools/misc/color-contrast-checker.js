...
export default function ToolPage() {
  return (
    <>
      <Head>
        <title>Color Contrast Checker - Dicetools</title>
        <meta name="description" content="Placeholder for Color Contrast Checker — Dicetools" />
      </Head>
      <section>
        <h1 className="text-2xl font-bold mb-4">Color Contrast Checker</h1>
