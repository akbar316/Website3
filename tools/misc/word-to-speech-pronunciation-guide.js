...
export default function ToolPage() {
  return (
    <>
      <Head>
        <title>Word to Speech Pronunciation Guide - Dicetools</title>
        <meta name="description" content="Placeholder for Word to Speech Pronunciation Guide — Dicetools" />
      </Head>
      <section>
        <h1 className="text-2xl font-bold mb-4">Word to Speech Pronunciation Guide</h1>
