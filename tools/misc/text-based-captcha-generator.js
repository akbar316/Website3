...
export default function ToolPage() {
  return (
    <>
      <Head>
        <title>Text-based CAPTCHA Generator - Dicetools</title>
        <meta name="description" content="Placeholder for Text-based CAPTCHA Generator — Dicetools" />
      </Head>
      <section>
        <h1 className="text-2xl font-bold mb-4">Text-based CAPTCHA Generator</h1>
