...
export default function ToolPage() {
  return (
    <>
      <Head>
        <title>Dice Roller - Dicetools</title>
        <meta name="description" content="Placeholder for Dice Roller — Dicetools" />
      </Head>
      <section>
