...
export default function ToolPage() {
  return (
    <>
      <Head>
        <title>Expense Splitter - Dicetools</title>
        <meta name="description" content="Placeholder for Expense Splitter — Dicetools" />
      </Head>
      <section>
        <h1 className="text-2xl font-bold mb-4">Expense Splitter</h1>
