...
export default function ToolPage() {
  return (
    <>
      <Head>
        <title>Minimal Site Search - Dicetools</title>
        <meta name="description" content="Placeholder for Minimal Site Search — Dicetools" />
      </Head>
      <section>
        <h1 className="text-2xl font-bold mb-4">Minimal Site Search</h1>
