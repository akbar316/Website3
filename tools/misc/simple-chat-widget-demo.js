...
export default function ToolPage() {
  return (
    <>
      <Head>
        <title>Simple Chat Widget Demo - Dicetools</title>
        <meta name="description" content="Placeholder for Simple Chat Widget Demo — Dicetools" />
      </Head>
      <section>
        <h1 className="text-2xl font-bold mb-4">Simple Chat Widget Demo</h1>
