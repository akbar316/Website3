...
export default function ToolPage() {
  return (
    <>
      <Head>
        <title>Sunrise / Sunset Time Finder - Dicetools</title>
        <meta name="description" content="Placeholder for Sunrise / Sunset Time Finder — Dicetools" />
      </Head>
      <section>
        <h1 className="text-2xl font-bold mb-4">Sunrise / Sunset Time Finder</h1>
