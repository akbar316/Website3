...
export default function ToolPage() {
  return (
    <>
      <Head>
        <title>Minimal Invoice Generator - Dicetools</title>
        <meta name="description" content="Placeholder for Minimal Invoice Generator — Dicetools" />
      </Head>
      <section>
        <h1 className="text-2xl font-bold mb-4">Minimal Invoice Generator</h1>
