...
export default function ToolPage() {
  return (
    <>
      <Head>
        <title>Favicon & App Icon Generator - Dicetools</title>
        <meta name="description" content="Placeholder for Favicon & App Icon Generator — Dicetools" />
      </Head>
      <section>
        <h1 className="text-2xl font-bold mb-4">Favicon & App Icon Generator</h1>
