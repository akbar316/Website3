...
export default function ToolPage() {
  return (
    <>
      <Head>
        <title>Currency Converter - Dicetools</title>
        <meta name="description" content="Placeholder for Currency Converter — Dicetools" />
      </Head>
      <section>
