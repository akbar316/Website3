...
export default function ToolPage() {
  return (
    <>
      <Head>
        <title>Habit Tracker Starter - Dicetools</title>
        <meta name="description" content="Placeholder for Habit Tracker Starter — Dicetools" />
      </Head>
      <section>
        <h1 className="text-2xl font-bold mb-4">Habit Tracker Starter</h1>
