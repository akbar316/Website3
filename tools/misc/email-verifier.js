...
export default function ToolPage() {
  return (
    <>
      <Head>
        <title>Email Verifier - Dicetools</title>
        <meta name="description" content="Placeholder for Email Verifier — Dicetools" />
      </Head>
      <section>
